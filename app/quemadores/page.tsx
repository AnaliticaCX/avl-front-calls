...
export default function QuemadoresLandingPage() {
    const modules = [
        ...
        {
            title: "Contactos",
            description: "Teléfonos y correos asociados a una obligación",
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <PageHeader
                ...
                description="Accede a los reportes de cartera quemada: paz y salvo, levantamiento DOSR, asignación jurídica y contactos"
            />

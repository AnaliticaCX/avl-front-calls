...
export default function ConnectedCallsPage() {
    ...
    const { results, loading, error, setError, cancel, run, reset, paging } = usePagedSearch('/api/calls/detalle_llamadas/search');
    ...
    const handleExportXLSX = () => {
        ...
        downloadXLSX(rows, `llamadas_conectadas_${getTodayString()}.xlsx`, 'Llamadas');
    };
    ...
    const columns = [
        ...
        { key: 'hang_up', label: 'Estado', render: (value: any) => <StatusPill value={value} /> },
        {
            key: 'actions',
            label: 'Acciones',
    ...
    return (
        <div className="mx-auto w-full max-w-[1800px] px-4 py-6 sm:px-6 lg:px-8">
            ...
            <InfoCallout id="calls-detalle_llamadas" title="¿Cómo buscar?">
            ...
            <SearchResults
                ...
                emptyMessage="No hay llamadas conectadas que coincidan con los criterios de búsqueda."
            />
        </div>
    );
}

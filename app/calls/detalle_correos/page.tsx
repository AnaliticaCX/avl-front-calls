...
export default function EmailReportPage() {
    const [showNote, setShowNote] = useLocalStorage('calls-correos-hide-note', false);
    ...
    const handleExportPDF = () => {
        ...
        downloadPDF(rows as Record<string, any>[], EXPORT_COLUMNS, {
            title: 'Detalle de Correos (CDR 9)',
    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <Breadcrumbs items={[
                ...
                { label: 'Detalle Correos', href: '/calls/detalle_correos' }
            ]} />
